...
<head>
    ...
    <%--<link rel="stylesheet" type="text/css" href="css/itemNumChoice.css">--%>
        ...
        <tr>
            ...
            <td width="70%" valign="top">
                ...
                <div class="row col-md-4 col-md-offset-5">
                    <button type="submit" class="btn btn-large btn-primary" id="submit" name="par" value="addShoppingCart">加入购物车</button>
                </div>
            </td>
